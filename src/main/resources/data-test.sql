...
INSERT INTO authors (id, first_name, last_name, profile, created_at, updated_at) VALUES
                                                                                     (1, 'John', 'Doe', 'https://example.com/johndoe', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                                                                                     (2, 'Jane', 'Smith', 'https://example.com/janesmith', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                                                                                     (3, 'Emily', 'Johnson', 'https://example.com/emilyjohnson', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    ON CONFLICT DO NOTHING;
